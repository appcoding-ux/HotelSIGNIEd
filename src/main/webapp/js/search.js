      ...
      onSelectRange: function() {
         ...
         $.ajax({
            ...
            success: function(response) {
               ...
               $('.night').text(bak);
               dateView = response.dateView;
               dateView2 = response.dateView2;
               console.log(date1);
               console.log(date2);
...
function amountCount(){
   ...
   $('.command').append("<input type='hidden' value='" + dateView + "' name='checkIn' />");
   $('.command').append("<input type='hidden' value='" + dateView2 + "' name='checkOut' />");
