			...
			<form action="HotelServlet" name="frm" method="post">
				...
				<div class="dateInput">
					...
					<div class="datePerson">
						...
						<input type="text" name="adultAmount" id="adultAmount" value="1" size="3" class="amounts">
						<input type="button" value=" + " onclick="add('adultAmount');">
						&nbsp;&nbsp;&nbsp; 어린이
						<!-- 어린이의 수를 조절하는 input -->
						<input type="button" value=" - " onclick="del('childAmount');">
						<input type="text" name="childAmount" id="childAmount" value="1" size="3" class="amounts">
